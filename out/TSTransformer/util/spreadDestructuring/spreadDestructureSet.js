...
exports.spreadDestructureSet = spreadDestructureSet;
const luau_ast_1 = __importDefault(require("@roblox-ts/luau-ast"));
function spreadDestructureSet(state, parentId, index, idStack) {
    ...
    state.prereq(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.ForStatement, {
        ids: luau_ast_1.default.list.make(keyId),
        expression: parentId,
        statements: luau_ast_1.default.list.make(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.IfStatement, {
            ...
            statements: luau_ast_1.default.list.make(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.CallStatement, {
                expression: luau_ast_1.default.call(luau_ast_1.default.globals.table.insert, [rest, keyId]),
            })),
        })),
    }));
    return rest;
}
//# sourceMappingURL=spreadDestructureSet.js.map