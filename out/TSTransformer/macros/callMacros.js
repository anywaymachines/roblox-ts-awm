...
exports.CALL_MACROS = {
    ...
    $compileTime: () => luau_ast_1.default.number(Date.now() / 1000),
    ...
    firstValue: (state, node, expression, args) => {
        return luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.ParenthesizedExpression, {
            expression: luau_ast_1.default.call(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.Identifier, { name: "select" }), [
                luau_ast_1.default.number(2),
                luau_ast_1.default.call(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.Identifier, { name: "next" }), [args[0]]),
            ]),
        });
    },
    firstKey: (state, node, expression, args) => {
        return luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.ParenthesizedExpression, {
            expression: luau_ast_1.default.call(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.Identifier, { name: "next" }), [args[0]]),
        });
    },
};
